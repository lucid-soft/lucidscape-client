	...
	static final void method765(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.extendedInfoNpcCount; ++var1) { // L: 8067
			...
			if ((var4 & 1024) != 0) { // L: 8075
				...
				var3.field1133 = (byte)var0.readByteSub(); // L: 8081
			}
			...
			if ((var4 & 2) != 0) { // L: 8111
				var3.spotAnimation = var0.readShortAdd(); // L: 8112
				...
				if (var6 > 0) { // L: 8145
					for (var7 = 0; var7 < var6; ++var7) { // L: 8146
						...
						if (var9 != 32767) { // L: 8149
							...
							var11 = var0.readByteSub(); // L: 8151
							int var12 = var9 > 0 ? var0.readByteSub() : var11; // L: 8152
			...
			if ((var4 & 8) != 0) { // L: 8165
				var3.definition = BuddyRankComparator.getNpcDefinition(var0.readShortAddLE()); // L: 8166
			...
			if ((var4 & 128) != 0) { // L: 8177
				var3.targetIndex = var0.readShortAddLE(); // L: 8178
			...
			if (class101.field1366 && (var4 & 256) != 0 || !class101.field1366 && (var4 & 64) != 0) { // L: 8181
				var3.field1140 = var0.readUnsignedByteSub(); // L: 8182
				var3.field1182 = var0.readUnsignedByteNeg(); // L: 8183
				var3.field1181 = var0.readUnsignedByteAdd(); // L: 8184
				var3.field1183 = var0.readUnsignedByteAdd(); // L: 8185
				var3.field1184 = var0.readShortAddLE() + Client.cycle; // L: 8186
				var3.field1194 = var0.readShortAdd() + Client.cycle; // L: 8187
				var3.field1186 = var0.readShortAddLE(); // L: 8188
			...
			if ((var4 & 1) != 0) { // L: 8196
				var5 = var0.readShortAddLE(); // L: 8197
				var6 = var0.readShortAdd(); // L: 8198
				if (class101.field1366) { // L: 8199
					var3.field1161 = var0.readByteNeg() == 1; // L: 8200
				}
